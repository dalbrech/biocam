...
This program is explicitly for testing PiCamera code. In the current version
it uses capture_sequence() over capture_continuous() which have subtle differences
