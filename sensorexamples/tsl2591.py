...
# Initialize the TSL2591sensor.
sensor_tsl = adafruit_tsl2591.TSL2591(i2c)
...
infrared = sensor_tsl.infrared
#print("Infrared light: {0}".format(infrared))
# Visible-only levels range from 0-2147483647 (32-bit)
#visible = sensor_tsl.visible
#print("Visible light: {0}".format(visible))
# Full spectrum (visible + IR) also range from 0-2147483647 (32-bit)
#full_spectrum = sensor_tsl.full_spectrum
#print("Full spectrum (IR + visible) light: {0}".format(full_spectrum))
print("TSL2591 -High Dynamic Range Light- Total light: {0:0.001f} lux Infrared light: {1}".format(lux,infrared))	
